...
$("#cbox").change(function () {
    ...
    $.ajax({
        ...
        type: 'PUT',
        data: {api_key: "IBQ9ORXYKZSS97NT",command_string:cmd},
        success: function(result, data, status) {
            alert('Update success: '+result);
            $.get("https://api.thingspeak.com/talkbacks/11796/commands/3224092?api_key=IBQ9ORXYKZSS97NT", function(data, status){
        alert("Data: " + data + "\nStatus: " + status);
        });
    }});
    });   
